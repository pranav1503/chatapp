         ...
         <div class="card card-danger">
           ...
           <div class="card-body">
               ...
               <div class="col-12">
                 <div class="form-group">
                   <div class="custom-control custom-checkbox">
                     <input class="custom-control-input ask-a-teacher" onclick="showTeacher()" type="checkbox" id="customCheckbox1" value="option1">
                     <label for="customCheckbox1" class="custom-control-label">Ask a particular teacher</label>
                   </div>
                 </div>
                 <!-- /.form-group -->
               </div>
             ...
             <div class="row">
               ...
               <div class="col-6 teacher-cluster" style="display:none">
                 <div class="form-group">
                   <label>Teacher</label>
                   <div class="autocomplete form-control">
